...
<b>به دلیل عدم مطابقت مبلغ تراکنش رد شد</b>",
    ...
    'lottery_admin_overview'=>"🎯 وضعیت قرعه کشی جاری\n\n💵 مبلغ هر کد: LOTTERY_AMOUNT تومان\n🕒 زمان قرعه کشی: LOTTERY_TIME\n🔢 کدهای ثبت شده: LOTTERY_CODES عدد",
    'lottery_no_round_defined'=>"فعلاً قرعه کشی فعالی تعریف نشده است. ابتدا مبلغ یا زمان را تنظیم کنید.",
    'lottery_enter_amount'=>"🔢 مبلغ هر کد قرعه کشی را به تومان وارد کنید:",
    'lottery_invalid_amount'=>"مقدار وارد شده معتبر نیست؛ فقط عددی بزرگتر از صفر وارد کنید.",
    'lottery_amount_saved'=>"✅ مبلغ قرعه کشی ذخیره شد.",
    'lottery_enter_time'=>"⏱ تاریخ و ساعت قرعه کشی را وارد کنید (فرمت: YYYY-MM-DD HH:MM به وقت تهران):",
    'lottery_time_format_error'=>"فرمت تاریخ/ساعت صحیح نیست. مثال: 2025-01-20 21:30",
    'lottery_time_saved'=>"✅ زمان قرعه کشی ذخیره شد.",
    'lottery_time_in_past'=>"زمان وارد شده باید در آینده باشد.",
    'lottery_codes_admin_header'=>"📋 لیست کدهای خریداری شده (حداکثر 20 مورد آخر)",
    'lottery_codes_admin_item'=>"کد: CODE | کاربر: USER | تاریخ: DATE",
    'lottery_codes_admin_empty'=>"هنوز هیچ کدی خریداری نشده است.",
    'lottery_codes_admin_count'=>"🔢 تعداد کل کدها: COUNT",
    'lottery_codes_admin_more'=>"و ...",
    'lottery_user_overview'=>"🎁 قرعه کشی نت باکس\n\n💵 مبلغ هر کد: LOTTERY_AMOUNT تومان\n🕒 زمان قرعه کشی: LOTTERY_TIME\n🔢 کدهای ثبت شده شما: USER_CODES عدد",
    'lottery_not_ready'=>"قرعه کشی هنوز آماده خرید نیست. منتظر اعلام ادمین باشید.",
    'lottery_purchase_not_enough_wallet'=>"موجودی کیف پول شما برای خرید این کد کافی نیست.",
    'lottery_purchase_success'=>"✅ کد قرعه کشی شما: LOTTERY_CODE \nمبلغ کسر شده: LOTTERY_PRICE تومان",
    'lottery_user_codes_header'=>"کدهای قرعه کشی شما:\nCODES\n",
    'lottery_user_codes_empty'=>"هنوز کدی خریداری نکرده‌اید.",
    'lottery_draw_winner_user'=>"🎉 تبریک! کد LOTTERY_CODE به عنوان نفر RANK انتخاب شد.\nبرای دریافت جایزه با ادمین تماس بگیرید.",
    'lottery_draw_winner_admin'=>"🎉 قرعه کشی انجام شد.\nRANKINGS\nبرای هماهنگی جوایز اقدام کنید.",
    'lottery_draw_insufficient_codes'=>"⛔️ قرعه کشی در زمان تعیین شده انجام شد اما هیچ کدی وجود نداشت.",
    'lottery_time_not_set'=>"ثبت نشده"
];
...
$buttonValues = [
    ...
    'lottery_admin'=>"🏆 مدیریت قرعه کشی",
    'lottery_manage_amount'=>"💵 مدیریت مبلغ قرعه کشی",
    'lottery_manage_time'=>"⏱ زمان قرعه کشی",
    'lottery_view_codes_admin'=>"📋 مشاهده کدها",
    'lottery_main_button'=>"قرعه کشی نت باکس",
    'lottery_buy_code'=>"🎫 خرید کد قرعه کشی",
    'lottery_view_codes_user'=>"📜 مشاهده کدها"
];
?>
